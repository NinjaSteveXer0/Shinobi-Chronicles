...
const PATCH_ID="alpha_kakashi_scene03a_35700_v5_2026_09_19";
...
function ensureWatchMotionStyle35700(){
  ...
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors{display:block!important;position:absolute!important;left:2.5%!important;right:2.5%!important;top:13%!important;bottom:18%!important;padding:0!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actor{position:absolute!important;bottom:0!important;width:min(20vw,285px)!important;max-height:430px!important;transition:left .38s cubic-bezier(.2,.75,.25,1),right .38s cubic-bezier(.2,.75,.25,1),transform .38s cubic-bezier(.2,.75,.25,1),opacity .34s ease!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actor:not(.sc-watch-mi-burst-35700):not(.sc-watch-amt-breakaway-35700):not(.sc-watch-amt-offstage-35700){opacity:1!important;filter:none!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='choice-ready'] .sc-scene-board-33900__actor:not(.sc-watch-amt-offstage-35700){opacity:1!important;filter:none!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='exchange'] [data-actor-id='academy_kakashi']{left:4%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='exchange'] [data-actor-id='anbu_marked_target']{left:37%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='exchange'] [data-actor-id='package_smuggler']{right:5%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='divergence'] [data-actor-id='academy_kakashi']{left:4%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='divergence'] [data-actor-id='anbu_marked_target']{left:20%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='divergence'] [data-actor-id='package_smuggler']{right:5%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interceptor-arrival'] [data-actor-id='academy_kakashi']{left:1.5%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interceptor-arrival'] [data-actor-id='anbu_marked_target']{left:14%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interceptor-arrival'] [data-actor-id='masked_interceptor']{right:27%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interceptor-arrival'] [data-actor-id='package_smuggler']{right:4%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='amt-breakaway'] [data-actor-id='academy_kakashi']{left:1.5%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='amt-breakaway'] [data-actor-id='anbu_marked_target']{left:14%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='amt-breakaway'] [data-actor-id='masked_interceptor']{right:27%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='amt-breakaway'] [data-actor-id='package_smuggler']{right:4%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interception'] [data-actor-id='academy_kakashi']{left:8%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interception'] [data-actor-id='masked_interceptor']{right:23%!important}"+
  "#story-scene-presentation-layer[data-sc-kakashi-watch-exchange='true'] .sc-scene-board-33900__actors[data-watch-stage='interception'] [data-actor-id='package_smuggler']{right:4%!important}"+
  ...
  "#story-scene-presentation-layer .sc-watch-amt-moving-35700{transform:translateX(-7.5vw) scale(.95)!important}"+
  "#story-scene-presentation-layer .sc-watch-ps-turn-35700{transform:translateX(1.2vw) scale(.98)!important}"+
  ...
  "#story-scene-presentation-layer .sc-watch-amt-offstage-35700{opacity:0!important;transform:translateX(-74vw) rotate(-3deg) scale(.91)!important;filter:none!important}"+
  "#story-scene-presentation-layer .sc-watch-mi-cutoff-35700{transform:translateX(5vw) scale(1.02)!important}"+
  "#story-scene-presentation-layer .sc-watch-ps-checked-35700{transform:translateX(1.5vw) scale(.96)!important}"+
  "@keyframes scWatchHandoffGiver35700{0%{transform:translateX(0) scale(.96)}48%{transform:translateX(2.6vw) scale(.98)}100%{transform:translateX(0) scale(.96)}}"+
  "@keyframes scWatchHandoffReceiver35700{0%{transform:translateX(0) scale(.96);filter:brightness(.78)}48%{transform:translateX(-2.6vw) scale(1.01);filter:brightness(1.16)}100%{transform:translateX(0) scale(1);filter:brightness(1)}}"+
  "@keyframes scWatchMiBurst35700{0%{opacity:0;transform:translateX(42vw) scale(.88);filter:blur(4px) brightness(1.35)}58%{opacity:1;transform:translateX(-2vw) scale(1.04);filter:blur(0) brightness(1.12)}100%{opacity:1;transform:translateX(0) scale(1);filter:none}}"+
  "@keyframes scWatchMiDrive35700{0%{transform:translateX(-4vw) scale(.96)}100%{transform:translateX(4vw) scale(1.02)}}"+
  "@keyframes scWatchAmtBreakaway35700{0%{opacity:.82;transform:translateX(-7.5vw) scale(.95)}100%{opacity:0;transform:translateX(-74vw) rotate(-3deg) scale(.91)}}"+
  "@media(prefers-reduced-motion:reduce){#story-scene-presentation-layer .sc-watch-handoff-giver-35700,#story-scene-presentation-layer .sc-watch-handoff-receiver-35700,#story-scene-presentation-layer .sc-watch-mi-burst-35700,#story-scene-presentation-layer .sc-watch-mi-drive-35700{animation:none!important}#story-scene-presentation-layer .sc-watch-amt-breakaway-35700,#story-scene-presentation-layer .sc-watch-amt-offstage-35700{animation:none!important;opacity:0!important;transform:translateX(-74vw)!important}}";
  document.head.appendChild(style);return true;
}
function watchStageForIndex35700(index){
  if(index<=5)return"exchange";
  if(index<=11)return"divergence";
  if(index<=13)return"interceptor-arrival";
  if(index===14)return"amt-breakaway";
  return"interception";
}
function syncWatchMotion35700(){
  ...
  const classes=["sc-watch-handoff-giver-35700","sc-watch-handoff-receiver-35700","sc-watch-amt-moving-35700","sc-watch-ps-turn-35700","sc-watch-mi-burst-35700","sc-watch-mi-drive-35700","sc-watch-amt-breakaway-35700","sc-watch-amt-offstage-35700","sc-watch-mi-cutoff-35700","sc-watch-ps-checked-35700"];
  ...
  const kak=actors.querySelector('[data-actor-id="academy_kakashi"]'),amtNode=actors.querySelector('[data-actor-id="anbu_marked_target"]'),psNode=actors.querySelector('[data-actor-id="package_smuggler"]'),miNode=actors.querySelector('[data-actor-id="masked_interceptor"]');
  if(choiceReady){actors.dataset.watchStage="choice-ready";actors.dataset.watchCue="choice";if(amtNode)amtNode.classList.add("sc-watch-amt-offstage-35700");if(miNode)miNode.classList.add("sc-watch-mi-cutoff-35700");if(psNode)psNode.classList.add("sc-watch-ps-checked-35700");if(kak)kak.dataset.watchRole="observer";return true;}
  ...
  if(index>=6&&index<=14&&amtNode)amtNode.classList.add("sc-watch-amt-moving-35700");
  ...
  if(index===14&&amtNode){amtNode.classList.remove("sc-watch-amt-moving-35700");amtNode.classList.add("sc-watch-amt-breakaway-35700");}
  if(index>=15&&amtNode){amtNode.classList.remove("sc-watch-amt-moving-35700");amtNode.classList.add("sc-watch-amt-offstage-35700");}
  ...
  if(kak)kak.dataset.watchRole="observer";
  return true;
}
...
function installPresentationHooks35700(){
  ...
  if(PRE_RENDER){globalThis.renderStoryScenePresentationLayer=function renderStoryScenePresentationLayer35700(){const result=PRE_RENDER.apply(this,arguments);if(typeof queueMicrotask==="function")queueMicrotask(syncPresentation35700);else setTimeout(syncPresentation35700,0);return result;};try{renderStoryScenePresentationLayer=globalThis.renderStoryScenePresentationLayer;}catch(_error){}}
