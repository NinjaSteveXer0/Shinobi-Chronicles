...
function blockedAvailability(){return{available:false,knownBlocker:BLOCKER};}
...
function installSemanticSurface35700(){
  ...
  major.choices=CHOICE_SPECS.map(spec=>({choiceId:spec.choiceId,label:spec.label,nextBeatId:MAJOR_BEAT,availability:blockedAvailability,knownBlocker:BLOCKER}));
