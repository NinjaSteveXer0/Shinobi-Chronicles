...
const PATCH_ID="alpha_kakashi_immediate_custody_35800_v1_2026_09_18";
...
function diagnostics(){const m=scene()&&scene().beatMap instanceof Map?scene().beatMap:null;const checks={
  patchId:PATCH_ID==="alpha_kakashi_immediate_custody_35800_v1_2026_09_18",
  ...
  receiptSeparate:openReceipt.toString().includes("document.body.appendChild"),browserCapture:installBrowserChoiceCapture.toString().includes("stopImmediatePropagation"),browserGoldenClaimed:false
...
globalThis.SC_ALPHA_KAKASHI_IMMEDIATE_CUSTODY_35800=Object.freeze({patchId:PATCH_ID,authorities:AUTH,anbuFirstBeat:D06,policeFirstBeat:E06,receiptBeatId:RECEIPT,exitBeatId:EXIT,wireChoices,commitStart,commitTransfer,commitReport,commitHidden,diagnostics,browserGoldenClaimed:false});
})();