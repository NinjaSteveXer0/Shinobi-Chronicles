  ...
  */
  ...
  if(typeof document!=="undefined"&&!document.getElementById("alpha-battle-modern-33000-style")){
    ...
    style.textContent=`
      ...
      .battle2-performance-host{position:absolute;left:36%;right:36%;top:15%;height:31%;z-index:32;pointer-events:none;overflow:visible}
      .battle2-performance-stage{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;isolation:isolate}
      .battle2-performance-center{width:100%;box-sizing:border-box;display:flex;min-height:132px;flex-direction:column;align-items:center;justify-content:center;padding:12px 14px;border:1px solid rgba(217,176,77,.28);background:radial-gradient(circle,rgba(20,50,57,.68),rgba(2,8,12,.84) 72%);box-shadow:0 18px 42px rgba(0,0,0,.42);text-align:center;backdrop-filter:blur(3px)}
      .battle2-performance-center small{color:#5fd9e2;font-size:7px;font-weight:900;letter-spacing:.11em}.battle2-performance-center strong{margin-top:7px;color:#f0e4ca;font:900 clamp(14px,1.25vw,20px)/1.08 Georgia,serif}
      .battle2-performance-center b{margin-top:9px;color:#e4b956;font-size:clamp(13px,1.15vw,19px);letter-spacing:.15em}.battle2-performance-center em{margin-top:5px;color:#d7e1df;font-style:normal;font-size:9px;font-weight:900}.battle2-performance-center span{margin-top:4px;color:#8a9da4;font-size:8px;font-weight:800;letter-spacing:.05em}
      .battle2-modern.battle2-performance-active .battle-live-active-card-player{left:5.5%!important}
      .battle2-modern.battle2-performance-active .battle-live-active-card-enemy{left:67.5%!important}
      .battle2-modern.battle2-performance-active .battle-live-active-card{transition:left .18s ease,filter .14s ease,opacity .14s ease,transform .14s ease!important}
      ...
      .battle2-modern .battle-live-active-card-player.battle2-performance-role-actor{--battle2-performance-strike-x:8%;--battle2-performance-impact-x:-5%;--battle2-performance-evade-x:-8%}
      .battle2-modern .battle-live-active-card-enemy.battle2-performance-role-actor{--battle2-performance-strike-x:-8%;--battle2-performance-impact-x:5%;--battle2-performance-evade-x:8%}
      .battle2-modern .battle-live-active-card-player.battle2-performance-role-target{--battle2-performance-impact-x:-5%;--battle2-performance-evade-x:-8%}
      .battle2-modern .battle-live-active-card-enemy.battle2-performance-role-target{--battle2-performance-impact-x:5%;--battle2-performance-evade-x:8%}
      .battle2-modern.battle2-performance-active[data-battle2-performance-class="PHYSICAL_STRIKE"] .battle2-performance-role-actor,.battle2-modern.battle2-performance-active[data-battle2-performance-class="HEAVY_STRIKE"] .battle2-performance-role-actor{animation:battle2ActorStrike33000 .42s cubic-bezier(.3,.75,.2,1) both}
      .battle2-modern.battle2-performance-active[data-battle2-performance-class="PROJECTILE"] .battle2-performance-role-actor,.battle2-modern.battle2-performance-active[data-battle2-performance-class="CHAKRA_RANGED"] .battle2-performance-role-actor{animation:battle2ActorCast33000 .42s ease both}
      .battle2-modern.battle2-performance-active[data-battle2-performance-result="HIT"] .battle2-performance-role-target,.battle2-modern.battle2-performance-active[data-battle2-performance-result="GUARD"] .battle2-performance-role-target{animation:battle2TargetImpact33000 .38s ease both}
      .battle2-modern.battle2-performance-active[data-battle2-performance-result="SUBSTITUTION"] .battle2-performance-role-target{animation:battle2Substitution33000 .48s ease both}
      .battle2-modern.battle2-performance-active[data-battle2-performance-result="DEFEAT"] .battle2-performance-role-target{animation:battle2Defeat33000 .56s ease both}
      .battle2-modern.battle2-performance-active[data-battle2-performance-result="EVADE"] .battle2-performance-role-target,.battle2-modern.battle2-performance-active[data-battle2-performance-result="MISS"] .battle2-performance-role-target{animation:battle2Evade33000 .38s ease both}
