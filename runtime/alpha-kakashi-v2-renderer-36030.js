...
@keyframes kv2ActorFlee36030{0%{opacity:1;transform:translate3d(0,0,0) scale(1)}22%{opacity:1;transform:translate3d(calc(var(--kv2-departure-x,70vw) * .08),-1%,0) scale(1.015)}100%{opacity:0;transform:translate3d(var(--kv2-departure-x,70vw),-4%,0) scale(.88)}}
...
function appendDepartureGhost(root,visual,kind){
  ...
  ghost.classList.remove("kv2-actor","is-entering","is-focus");
