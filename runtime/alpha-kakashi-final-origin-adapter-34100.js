...
// const BUILD="kakashi-final-20260919-52";
// const BUILD="kakashi-final-20260919-53";
// const BUILD="kakashi-final-20260919-54";
// const BUILD="kakashi-final-20260919-57";
// const BUILD="kakashi-final-20260919-58";
// const BUILD="kakashi-final-20260919-60";
// const BUILD="kakashi-final-20260919-61";
// const BUILD="kakashi-final-20260919-62";
...
// const BUILD="kakashi-final-20260920-71";
// const BUILD="kakashi-final-20260920-72";
// const BUILD="kakashi-final-20260920-73";
// const BUILD="kakashi-final-20260920-75";
// const BUILD="kakashi-final-20260920-76";
// const BUILD="kakashi-final-20260920-77";
// const BUILD="kakashi-final-20260920-78";
// const BUILD="kakashi-final-20260920-79";
// const BUILD="kakashi-final-20260920-80";
...
const BUILD="kakashi-final-20260922-97";
...
function loadMoveCloserClosure(){
  ...
  appendScript("sc-alpha-kakashi-move-closer-closure-35930-script",MOVE_CLOSER_CLOSURE_PATH,loadDynamicTerminal);
}
...
function loadKonohaRouteClosure(){
  ...
  appendScript("sc-alpha-kakashi-konoha-route-closure-35910-script",KONOHA_ROUTE_CLOSURE_PATH,loadFieldSecured);
}
function loadKonohaClosure(){
  if(globalThis.SC_ALPHA_KAKASHI_KONOHA_CLOSURE_35900){loadKonohaRouteClosure();return;}
  appendScript("sc-alpha-kakashi-konoha-writing-closure-35900-script",KONOHA_CLOSURE_PATH,loadKonohaRouteClosure);
}
function loadPostMiPursuit(){
  if(globalThis.SC_ALPHA_KAKASHI_POST_MI_DEATH_PURSUIT_35830){loadKonohaClosure();return;}
  appendScript("sc-alpha-kakashi-post-mi-death-pursuit-35830-script",POST_MI_PURSUIT_PATH,loadKonohaClosure);
}
