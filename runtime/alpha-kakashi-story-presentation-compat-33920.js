...
function runAcademyKakashiStoryPresentationCompat33920Diagnostics(){
  ...
  const checks={
    ...
    narrationClearsDialogue:clearRetainedDialogue33920.toString().includes("is-retained")&&css.includes('[data-sc-board-ui-mode="performance_narration"] .sc-dialogue-panel-33910{display:none!important}'),
