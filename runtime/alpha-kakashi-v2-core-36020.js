...
addBeat("v2_mi_anbu_handoff",{backdrop:B.rooftop,location:"ANBU ROOFTOP · NIGHT",objective:"Transfer custody.",actors:()=>directTransferActors("MI","ANBU",true),preset:"anbu_handoff",cues:()=>directTransferHandoffCues("MI","ANBU"),onAdvance:()=>completeDirectTransfer("MI","ANBU","mi"),nextBeatId:"v2_report"});
...
addBeat("v2_ps_anbu_handoff",{backdrop:B.rooftop,location:"ANBU ROOFTOP · NIGHT",objective:"Transfer custody.",actors:()=>directTransferActors("PS","ANBU",true),preset:"anbu_handoff",cues:()=>directTransferHandoffCues("PS","ANBU"),onAdvance:()=>completeDirectTransfer("PS","ANBU","ps"),nextBeatId:"v2_report"});
...
addBeat("v2_amt_anbu_handoff",{backdrop:B.rooftop,location:"ANBU ROOFTOP · NIGHT",objective:"Transfer custody.",actors:()=>directTransferActors("AMT","ANBU",true),preset:"anbu_handoff",cues:()=>directTransferHandoffCues("AMT","ANBU"),onAdvance:()=>completeDirectTransfer("AMT","ANBU","amt"),nextBeatId:"v2_report"});
