...
addBeat("v2_secure_amt_pursuit_resolver",{mode:"resolver",machineResolved:true,backdrop:B.alleyAlt,location:"KONOHA · PURSUIT",objective:"Catch the first man.",actors:["kakashi","amt"],preset:"pursuit",onEnter:()=>resolverEnter("secureAmtPursuit"),cues:[
...
addBeat("v2_secure_before_resolver",{mode:"resolver",machineResolved:true,backdrop:B.sakura,location:"SAKURA TREE · NIGHT",objective:"Retrieve the package.",actors:["kakashi","ps","mi"],preset:"sakura_3_person",onEnter:()=>resolverEnter("secureBefore"),cues:W("secureBeforeAssassin","1_secure_the_package_before_the_assassin"),choices:[
...
addBeat("v2_mi_package_second_win",{mode:"resolver",machineResolved:true,backdrop:B.fight,location:"SAKURA TREE · NIGHT",objective:"Catch the package.",actors:["kakashi","mi"],preset:"post_battle",onEnter:ctx=>captureBattle("mi_package_second",ctx,s=>{s.participants.MI.state="BATTLE_DEFEATED";}),cues:()=>battleActions("mi_package_second")<=4?[N("Masked Interceptor goes down."),N("Footsteps are still carrying through the next street."),N("Kakashi looks once at her."),N("Then runs."),N("The package is moving ahead of him.")]:[N("Masked Interceptor goes down."),N("Kakashi turns immediately."),N("Listens."),N("Nothing."),N("He takes the roof anyway."),N("One building."),N("Then another."),N("No package."),N("No running footsteps."),N("No line worth following."),N("Kakashi stops."),N("Looks back once toward the Sakura tree."),N("Then turns toward ANBU.")],choices:[
...
addBeat("v2_package_second_ps_pursuit",{mode:"resolver",machineResolved:true,backdrop:B.alleyAlt,location:"KONOHA · PURSUIT",objective:"Catch the package.",actors:["kakashi","ps"],preset:"pursuit",onEnter:()=>resolverEnter("psPursuit"),cues:[N("Masked Interceptor goes down quickly enough that the next problem is still audible."),N("Footsteps."),N("Fading."),N("Not gone."),N("Kakashi looks once at the masked woman."),N("His attention snaps back to the package route."),N("Package Smuggler has a lead."),N("Not an insurmountable one."),N("Kakashi moves.")],choices:[
...
addBeat("v2_package_second_amt_pursuit",{mode:"resolver",machineResolved:true,backdrop:B.alleyAlt,location:"KONOHA · PURSUIT",objective:"Catch the first man.",actors:["kakashi","amt"],preset:"pursuit",onEnter:()=>resolverEnter("secureAmtPursuit"),cues:[N("Kakashi leaves Package Smuggler behind."),N("The package is secured."),N("The first man's trail is thin."),N("Still usable."),N("Kakashi takes it.")],choices:[
...
// ---------------------------------------------------------------------------
addBeat("v2_go_amt_pursuit_resolver",{mode:"resolver",machineResolved:true,backdrop:B.alleyAlt,location:"KONOHA · PURSUIT",objective:"Catch ANBU Marked Target.",actors:["kakashi","amt"],preset:"pursuit",onEnter:()=>{participant("PS",{state:"ESCAPED"});return resolverEnter("amtPursuitRoot");},cues:W("originalTarget","1_go_after_the_original_target"),choices:[
...
addBeat("v2_stay_package_pursuit_resolver",{mode:"resolver",machineResolved:true,backdrop:B.sakura,location:"SAKURA TREE · PURSUIT",objective:"Catch ANBU Marked Target.",actors:["kakashi","amt"],preset:"pursuit",onEnter:()=>resolverEnter("stayPackagePursuit"),cues:[N("ANBU Marked Target is already moving away with the package. Kakashi goes after him."),N("Package Smuggler catches the movement at the alley mouth."),Q("PACKAGE SMUGGLER","There!"),N("The carrier looks back and sees Kakashi for the first time."),Q("ANBU MARKED TARGET","A kid?"),N("Kakashi runs straight past Package Smuggler's reach."),Q("PACKAGE SMUGGLER","Don't stop!"),Q("ANBU MARKED TARGET","You said I was done!"),Q("PACKAGE SMUGGLER","Not while you're holding it!"),N("That gives Kakashi one more useful fact: the carrier was never meant to keep the package."),N("The chase breaks into the open around the Sakura tree."),Q("ANBU MARKED TARGET","What do you want?"),Q("KAKASHI","The package."),N("The man gives a short, breathless laugh and changes direction around the tree."),N("Kakashi stops trying to match his speed and starts reading the exits instead.")],choices:[
...
addBeat("v2_improved_pickpocket_resolver",{mode:"resolver",machineResolved:true,backdrop:B.endAlley,location:"END OF ALLEYWAY · NIGHT",objective:"Take the package cleanly.",actors:["kakashi","amt","ps"],preset:"observe",onEnter:()=>resolverEnter("improvedPickpocket"),cues:[N("Kakashi has already shortened the distance and heard the contingency."),N("ANBU Marked Target's hand is still over the package. Package Smuggler is waiting."),N("Kakashi uses the closer position to try to remove the package before the handoff can finish.")],choices:[
...
// DIRECT PICKPOCKET.
// ---------------------------------------------------------------------------
addBeat("v2_direct_pickpocket_resolver",{mode:"resolver",machineResolved:true,backdrop:B.sakura,location:"SAKURA TREE · NIGHT",objective:"Take the package cleanly.",actors:["kakashi","amt","ps"],preset:"observe",onEnter:()=>resolverEnter("directPickpocket"),cues:G("f05.slip"),choices:[
...
function diagnostics(){
 ...
 const checks={
  ...
  resolverPseudoChoicesRetired:!JSON.stringify(beats).includes('"CONTINUE"')&&beats.filter(b=>b.machineResolved===true).length===11&&beats.filter(b=>b.machineResolved===true).every(b=>b.mode==="resolver"&&b.choices.length===2&&b.choices.every(ch=>ch.label==="RESOLVE RESULT")),
