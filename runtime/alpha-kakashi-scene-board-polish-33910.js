...
if(PRE_RENDER_33910){function renderStoryScenePresentationLayer33910(){const before=currentRuntime(),entering=!!before&&before.sceneId===scene&&lastRenderedSceneId!==scene,curtain=entering?createEntryCurtain():null,result=PRE_RENDER_33910.apply(this,arguments),after=currentRuntime();lastRenderedSceneId=after&&after.sceneId||null;syncPresentation();if(curtain)revealEntryCurtain(curtain);return result;}globalThis.renderStoryScenePresentationLayer=renderStoryScenePresentationLayer33910;try{renderStoryScenePresentationLayer=renderStoryScenePresentationLayer33910;}catch(_error){}}
