...
#story-scene-presentation-layer .${BOARD_CLASS} .sc-kakashi-state-exit-right-35710{
  animation:kakashiStateExitRight35710 560ms cubic-bezier(.36,.08,.76,.3) both!important;
}
...
@keyframes kakashiStateExitLeft35710{0%{opacity:.8;transform:translateX(0) scale(.95)}100%{opacity:0;transform:translateX(-68vw) rotate(-3deg) scale(.94)}}
@keyframes kakashiStateExitRight35710{0%{opacity:.8;transform:translateX(0) scale(.95)}100%{opacity:0;transform:translateX(68vw) rotate(3deg) scale(.94)}}
