...
function installTerminalBeats35100(){
  ...
  const beats=[
    ...
    {beatId:PAKKUN_1,mode:"dialogue",environmentRef:{assetId:ROOFTOP_ENV},objectiveText:"Report the mission outcome to ANBU.",speakerName:"PAKKUN",text:"I'm heading off.",nextBeatId:PAKKUN_2,exitScene:false,allowPresentationClose:false},
    ...
    {beatId:PAKKUN_3,mode:"dialogue",environmentRef:{assetId:ROOFTOP_ENV},objectiveText:"Report the mission outcome to ANBU.",speakerName:"PAKKUN",text:"You said that already.",nextBeatId:PAKKUN_EXIT,exitScene:false,allowPresentationClose:false},
