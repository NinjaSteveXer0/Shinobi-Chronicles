...
function board(rt,p){
  ...
  const officeActors=[
    card(MINATO,"MINATO","Assets/Kage/kage_minato.png","PACKAGE RECOVERED · HIDDEN OPERATION",focus===MINATO,""),
  ...
  return'<div class="sc-scene-board-33900__top"><div class="sc-scene-board-33900__location">HOKAGE ADMINISTRATION · NIGHT</div></div><div class="sc-scene-board-33900__actors" data-count="'+(anbuVisible?5:4)+'">'+officeActors+'</div>';
}
