...
try{
  ...
  assert("scene_board_delivery_generation_coherent",terminalSource.includes('const SCENE_BOARD_BUILD="scene-board-20260921-12";')&&restorationSource.includes('const BUILD="scene-board-20260921-12";'));
  ...
  assert("kakashi_v13_exact_patch_id",kakashiV4Source.includes('kakashi_scene_board_model_v14_33910_2026_09_21'));
  ...
  assert("postmi_dialogue_first_paint_owned_by_33910",kakashiV4Source.includes('data-sc-postmi-lane="field"')&&kakashiV4Source.includes("top:2%!important")&&kakashiV4Source.includes('data-speaker-id="pakkun"'));
