...
try{
  ...
  const kakashiV3Source=read("runtime/alpha-kakashi-scene-board-polish-33910.js");
  ...
  assert("scene1_delivery_generation_coherent",terminalSource.includes('const SCENE_BOARD_BUILD="scene-board-20260917-5";')&&restorationSource.includes('const BUILD="scene-board-20260917-5";'));
  assert("restoration_activates_generic_board_then_kakashi_v3",restorationSource.includes('runtime/alpha-story-scene-board-33900.js')&&restorationSource.includes('runtime/alpha-kakashi-scene-board-polish-33910.js'));
  ...
  assert("kakashi_v3_diagnostics_green",d33910.pass===true,d33910);
  assert("kakashi_v3_exact_patch_id",kakashiV3Source.includes('kakashi_scene_board_model_v3_33910_2026_09_17'));
  assert("scene1_authority_pinned",kakashiV3Source.includes('d11aa0f4f8e1ee203d3b63cee9a1b0d2fa88ea91'));
  const exactScene1=[
  ...
  console.log(JSON.stringify({pass:true,kind:"kakashi_scene1_verbatim_scene_board_v3",scene1Authority:"d11aa0f4f8e1ee203d3b63cee9a1b0d2fa88ea91",browserGoldenClaimed:false},null,2));
