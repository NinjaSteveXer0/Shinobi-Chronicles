...
try{
  ...
  assert("scene_board_delivery_generation_coherent",terminalSource.includes('const SCENE_BOARD_BUILD="scene-board-20260922-20";')&&restorationSource.includes('const BUILD="scene-board-20260922-20";'));
  ...
  assert("kakashi_v21_exact_patch_id",kakashiV4Source.includes('kakashi_scene_board_model_v21_33910_2026_09_22'));
