...
try{
  ...
  const scene04Source=read("runtime/alpha-kakashi-scene04a-35710.js");
  ...
  assert("scene_board_delivery_generation_coherent",terminalSource.includes('const SCENE_BOARD_BUILD="scene-board-20260922-21";')&&restorationSource.includes('const BUILD="scene-board-20260922-21";'));
  ...
  assert("scene_board_dialogue_lifecycle_is_canonical",kakashiV4Source.includes('const PRESENTATION_HOOK_ID_33910="kakashi_scene_board_projection_33910"')&&kakashiV4Source.includes("registerStorySceneBoardRenderHook(PRESENTATION_HOOK_ID_33910")&&kakashiV4Source.includes('function syncNativePerformanceLayout33910(layer){')&&kakashiV4Source.includes('node.style.removeProperty("display")')&&kakashiV4Source.includes("!syncNativePerformanceLayout33910.toString().includes('setProperty(\"display\",\"none\",\"important\")')"));
  ...
  assert("kakashi_v21_exact_patch_id",kakashiV4Source.includes('kakashi_scene_board_model_v22_33910_2026_09_22'));
  ...
  assert("terminal_wipe_has_single_render_owner",sceneBoardSource.includes("globalThis.performStorySceneCut33900=performSceneCut")&&sceneBoardSource.includes("story_scene_board_33900_v3_2026_09_22_single_transition_owner")&&!kakashiV4Source.includes(".sc-kakashi-wipe-33910{")&&!kakashiV4Source.includes("globalThis.performKakashiSceneWipe33910="));
  ...
  assert("golden_completed_prechoice_narrative_is_removed_before_choices",kakashiV4Source.includes('data-sc-choice-performance-complete="true"')&&kakashiV4Source.includes('cursorState.complete===true')&&kakashiV4Source.includes('layer.dataset.scChoicePerformanceComplete=choicePerformed?"true":"false"'));
  ...
  const directKill=projection("kak_konoha_direct_strike_kill_all_35910");
