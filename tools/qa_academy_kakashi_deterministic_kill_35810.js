...
let classified=globalThis.SC_STORY_DECISION_REALISATION_34000.recordParticipantClassification({storyUnitRef:"academy_kakashi",participantRef:MI,stateClass:"CONTROLLED_DEFEATED",resultRef:"qa-controlled"});
...
console.log("- CONTROLLED_DEFEATED only; KILL is never downgraded to ATTEMPT");
