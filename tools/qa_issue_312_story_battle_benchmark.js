...
assert(kv2Rewards.includes("battleOppositionIds36015")&&kv2Rewards.includes("count===1")&&kv2Rewards.includes("ryo:100")&&kv2Rewards.includes("FAILED_PICKPOCKET_3V1_CONFIG")&&kv2Rewards.includes("ryo:exactSet?200:0"),"#312 Kakashi immediate Battle rewards must cover 1v1 / 2v1 / authorised 3v1 by factual opposition");
assert(battleSource.includes(".battle-live-active-card-player .battle-live-active-nameplate{display:none!important}")&&battleSource.includes(".battle-live-roster-player .battle-live-roster-name{display:none!important}"),"#312 player participant name text must be suppressed on Formation Stage cards");
...
assert(battleSource.includes('data-formation-mode="duel"] .battle-live-active-card{top:12.5%!important;width:33.5%!important;height:53.5%!important')&&battleSource.includes('data-formation-mode="duel"] .battle-code-vs{top:28.5%!important;opacity:.55!important'),"#312 sparse duel must keep a clean top HUD lane while using the battlefield confidently");
assert(battleSource.includes('data-formation-mode="duel"] .battle-live-power,')&&battleSource.includes("top:43.5%!important")&&battleSource.includes("left:43.5%!important")&&battleSource.includes("left:56.5%!important"),"#312 active PL rings must share one mirrored confrontation lane across duel/wedge/arc");
