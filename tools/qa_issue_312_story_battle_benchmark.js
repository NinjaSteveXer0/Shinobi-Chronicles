...
assert(battleSource.includes('data-formation-mode="duel"] .battle-live-power{top:45.5%!important}')&&battleSource.includes(".battle-live-power-player{left:41.5%!important}")&&battleSource.includes(".battle-live-power-enemy{left:58.5%!important"),"#312 Duel PL rings must flank the center confrontation lane instead of sitting below the portraits");
