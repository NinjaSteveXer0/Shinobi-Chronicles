...
const report=plain(`runAcademyKakashiSequentialConsumer34410Diagnostics()`,`diag.js`);
assert.strictEqual(report.pass,true,`34410 diagnostics failed: ${report.failed.join(",")}`);
...
console.log(JSON.stringify({pass:true,patch:"34410",sequentialChoiceActionable:true,miGate:4,psGate:3,finalPakkunConfig:true,falseTerminalCompletionPrevented:true,browserGoldenClaimed:false},null,2));
