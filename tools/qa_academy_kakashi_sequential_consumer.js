...
assert.ok(/script\.src="runtime\/alpha-story-decision-realisation-34000\.js\?sc=story-decision-20260922-25";/.test(integrator),"active Story decision delivery must be Golden repair generation 25");
assert.ok(/script\.src="runtime\/alpha-kakashi-final-origin-adapter-34100\.js\?sc=kakashi-final-20260922-97";/.test(storyDecision),"active Kakashi parent delivery must be generation 97");
assert.ok(/^const BUILD="kakashi-final-20260922-97";$/m.test(loader),"active Kakashi child BUILD must be generation 97");
