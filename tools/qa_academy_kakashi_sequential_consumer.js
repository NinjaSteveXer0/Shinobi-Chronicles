...
assert.ok(/script\.src="runtime\/alpha-story-decision-realisation-34000\.js\?sc=story-decision-20260921-21";/.test(integrator),"active Story decision delivery must be generation 21");
assert.ok(/script\.src="runtime\/alpha-kakashi-final-origin-adapter-34100\.js\?sc=kakashi-final-20260921-93";/.test(storyDecision),"active Kakashi parent delivery must be gen93");
assert.ok(/^const BUILD="kakashi-final-20260921-93";$/m.test(loader),"active Kakashi child BUILD must be gen93");
