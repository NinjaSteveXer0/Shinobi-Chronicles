...
assert.ok(/script\.src="runtime\/alpha-story-decision-realisation-34000\.js\?sc=story-decision-20260921-19";/.test(integrator),"active Story decision delivery must be generation 19");
assert.ok(/script\.src="runtime\/alpha-kakashi-final-origin-adapter-34100\.js\?sc=kakashi-final-20260921-91";/.test(storyDecision),"active Kakashi parent delivery must be gen91");
assert.ok(/^const BUILD="kakashi-final-20260921-91";$/m.test(loader),"active Kakashi child BUILD must be gen91");
