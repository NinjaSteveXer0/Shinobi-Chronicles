...
assert(/^const BUILD="kakashi-final-20260921-91";$/m.test(loader),"Kakashi loader not on gen91");
assert(/story-decision-20260921-19/.test(integrator),"root Story delivery not generation 19");
assert(/kakashi-final-20260921-91/.test(storyDecision),"Story Decision does not deliver Kakashi gen91");
assert(/scene-board-20260921-15/.test(restoration),"Scene Board bootstrap not generation 15");
