...
assert(major.choices.every(row=>typeof row.availability==="function"&&row.availability().available===false),"Unauthorised successor scene was released in advance of its Writing lock");
...
console.log("- exact five-way choice surface installed; unauthorised successors remain fail-closed");
