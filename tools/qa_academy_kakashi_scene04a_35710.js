...
assert(scene04Source.includes("kakashiBlockEntry35710"),"Kakashi intervention/block animation missing");
assert(scene04Source.includes("opacity:1!important;filter:none!important"),"Scene 04A live actors must remain vivid");
