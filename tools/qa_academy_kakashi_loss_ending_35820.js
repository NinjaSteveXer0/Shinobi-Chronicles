...
assert(source.includes("alpha_kakashi_loss_ending_35820_v5_2026_09_22"),"loss-ending canonical-presentation repair generation missing");
...
assert(!source.includes(".sc-chronicle-layout{display:none!important}")&&!source.includes("layer.dataset.scBoardUiMode")&&source.includes("performStorySceneCut33900"),"loss route must delegate dialogue visibility and scene cuts to canonical 33910/33900 owners");
