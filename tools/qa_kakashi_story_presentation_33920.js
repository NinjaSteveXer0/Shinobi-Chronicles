...
assert(compat.includes("clearRetainedDialogue33920")&&compat.includes("Narration never carries the previous spoken panel forward")&&!compat.includes("function injectRetainedDialogue33920"),"narration must suppress and remove stale retained dialogue");
