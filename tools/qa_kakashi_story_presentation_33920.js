...
assert(restoration.includes('const BUILD="scene-board-20260921-12";'));
assert(traversal.includes('const SCENE_BOARD_BUILD="scene-board-20260921-12";'));
