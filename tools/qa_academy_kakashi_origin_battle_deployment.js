...
assert.strictEqual(report.configIds.length,7);
...
console.log(JSON.stringify({pass:true,patch:report.checks.patchId?"34300":null,configCount:report.configIds.length,exactOppositionProfiles:true,multiEnemyExistingApi:true,pakkunTemporaryActionSource:true,browserGoldenClaimed:false},null,2));
