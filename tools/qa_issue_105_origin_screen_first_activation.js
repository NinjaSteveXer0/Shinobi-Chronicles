...
const expected=["patchHinata()","patchIzuno()","patchMirai()","patchKushina()","patchKurenai()","patchIwabee()","patchMetal()","patchObito()","patchMenma()"];
const checks={
  ...
  nonKakashiOriginsProjected:expected.every(token=>screenFirst.includes(token)),
