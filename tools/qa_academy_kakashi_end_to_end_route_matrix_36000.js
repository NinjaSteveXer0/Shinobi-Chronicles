...
assert(/^\s*const BUILD="scene-board-20260921-14";$/m.test(restoration),"active Scene Board restoration delivery is not generation 14");
assert(/^const SCENE_BOARD_BUILD="scene-board-20260921-14";$/m.test(traversal),"active traversal Scene Board delivery is not generation 14");
