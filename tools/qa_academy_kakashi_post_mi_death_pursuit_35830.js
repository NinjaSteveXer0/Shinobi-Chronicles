...
assert(source35830.includes('"Assets/Summons/pakkun.png"'),"Pakkun Story scene asset path missing");
assert(!source35830.includes('"Portraits/Summons/pakkun.png"'),"Battle portrait must not be used for Pakkun Story presentation");
