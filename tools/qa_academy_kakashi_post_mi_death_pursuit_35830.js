...
const source33910=fs.readFileSync(path.resolve(process.cwd(),"runtime/alpha-kakashi-scene-board-polish-33910.js"),"utf8");
...
assert(source35830.includes("scPostmiLane")&&source35830.includes('registerStorySceneBoardRenderHook("kakashi_post_mi_35830"')&&source35830.includes("primePostMiPresentationState35830();materializePsDecision();materializeAmtDecision();const out=render()"),"35830 must prime semantic route/lane state inside the canonical 33900 render hook");
assert(source33910.includes("top:4%!important")&&!source33910.includes("top:2%!important"),"33910 must own one stable canonical dialogue lane; post-MI must not own first-paint geometry");
