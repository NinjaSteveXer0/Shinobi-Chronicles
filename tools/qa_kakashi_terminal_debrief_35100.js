...
function isValidDisciplineTrainingSource(disciplineId,source){return (disciplineId==="buki"&&source==="practical")||(disciplineId==="nin"&&source==="exam");}
...
assert(/^const BUILD="kakashi-final-20260922-97";$/m.test(loader),"active Kakashi child BUILD must be generation 97");
