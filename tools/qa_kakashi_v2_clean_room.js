...
assert(rendererSource.includes(".kv2-card-frame{display:none!important}")&&!rendererSource.includes('frame.className="kv2-card-frame"'),"Kakashi phantom Story card-holder chrome was not retired");
