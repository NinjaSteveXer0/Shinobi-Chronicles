...
|---|---|---|---|---|---|---|---|---|
| `academy_hinata` | `Assets/Academy Student/academy_hinata.png` | `06315be0e02f13dd334260a26a58b30af8eacd11` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_iwabe` | `Assets/Academy Student/academy_iwabe.png` | `364388051c4b250dee9ddb59107418735f99cd5e` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_izuno` | `Assets/Academy Student/academy_izuno.png` | `97d3fbb395018815a007f6edfdc4789085e7de6b` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_kakashi` | `Assets/Academy Student/academy_kakashi.png` | `c021b04d33efd3db9bcdb96991987384ac7673f1` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_kurenai` | `Assets/Academy Student/academy_kurenai.png` | `ed9746570d6f004d882d03558044b911ccd532dc` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_kushina` | `Assets/Academy Student/academy_kushina.png` | `36cdef54ddcbea06fc2bf55152c6fce1316944b2` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_menma` | `Assets/Academy Student/academy_menma.png` | `f7b9e56831b26eceb74cc6029a7601bf8a9a7c4d` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_metal` | `Assets/Academy Student/academy_metal.png` | `7d43742e4ea83e1ac998ef8c3d2683dc6a02216b` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_mirai` | `Assets/Academy Student/academy_mirai.png` | `71c1fccfbe59a829fb13ea5fce3cb8ec330a3a86` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
| `academy_obito` | `Assets/Academy Student/academy_obito.png` | `3c7559ef5162a3a62433e9169541e213c1e0a9a1` | PENDING | PENDING | **PENDING** | **VISUAL REVIEW REQUIRED / SOURCE-ONLY VERIFIED** | NO | Exact source row verified; pixel audit pending. |
